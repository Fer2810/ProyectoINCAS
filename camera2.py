"""
Reconocimento y comparacion de descriptores faciales en vivo, de manera fluida  
=================================================================================
1.Error al hacer la comparacion con los descriptores faciales : 

Hace el reconocimiento y captura de descriptores faciales en vivo de manera que los captura una vez, al detectar el primer rostro
de esta manera no hace el reconocimiento y comparacion de descriptores en cada iteracion del bucle, de igual manera que cuando hace la consulta de 
los descriptores a la base de datos lo hace una vez, pero no sabe quien es quien a la hora de detectar un rostro en la camara, arroja que la persona detectada
es cualqueira de la base de datos, o bien puede ser el primer o el segundo registro lo toma como la persona detectada en vivo.
...
def generate():
    ...
    while camera_running:
        ...
        # Actualizar los nombres y descriptores faciales de la base de datos en cada iteración
        #names_descriptors_from_db = get_names_and_facial_descriptors_from_db()
