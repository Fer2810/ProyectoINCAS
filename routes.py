...
def toggle_presentes():
    try:
        ...
        cursor.execute("""
            INSERT INTO presentes (nie, nombre, apellido, correo_electronico, genero, bachillerato, imagen, descriptores_faciales, id_año, estado)
            SELECT nie, nombre, apellido, correo_electronico, genero, bachillerato, imagen, descriptores_faciales, id_año, 0
            FROM estudiantes
...
@app.route('/reportes_materia', methods=['GET'])
